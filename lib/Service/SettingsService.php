...
class SettingsService {
	...
	public function getUrl(): string {
		return $this->config->getAppValue($this->appName, 'url', '');
	}

	public function getUsername(): string {
		return $this->config->getAppValue($this->appName, 'username', '');
	}

	public function getPassword(): string {
		return $this->config->getAppValue($this->appName, 'password', '');
	}
	...
	public function getSignatureFields(): array {
		$raw = $this->config->getAppValue($this->appName, self::SIGNATURE_FIELDS_KEY, '[]');
