	...
	<div class="sectionSignotecSignoSignUniversal">
		...
		<form class="settings-form" @submit.prevent="saveSettings">
			<div class="form-group">
				...
				<input id="url" v-model="settings.url" type="text" required style="min-width: 500px">
			</div>
			...
			<div class="form-group">
				...
				<input id="username" v-model="settings.username" type="text" required style="min-width: 500px">
			</div>
								...
								<tr v-for="(
									...
									<td>
										<input :id="`field-width-${index}`" v-model.number="field.width" type="number"
											min="1" required style="min-width: 50px">
									</td>
									...
									<td>
										<input :id="`field-offsetx-${index}`" v-model.number="field.offsetX"
											type="number" required style="min-width: 50px">
									</td>
			...
			<div class="form-actions">
				<NcButton type="submit" variant="success" class="button button-primary">
